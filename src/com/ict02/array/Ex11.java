...
public class Ex11 {
	...
	// 클래스의 구조 : 헤더, 멤버필드, 멤버메소드, 생성
	// 1. 헤더 : [접근제한자] [클래스종류] class 클래스이름{
	// 			 멤버필드, 멤버메소드, 생성자
	//		}
	// - 접근제한자 : 외부에서 접근할수 있는 권한을 말한다.
	// - 			  클래스, 멤버필드, 멤버메소드, 생성자 모두 맨 앞에 표시할수있다.(생략가능)
	// 1) public    : 누구나 다 접근 가능
	// 2) protected : 같은 패키지에 있거나, 상속관계에서는 접근 가능
	// 3) 생략      : 같은 패키지 에서만 접근 가능
	// 4) private   : 외부에서는 무조건 접근이 불가
	//				  내부멤버(필드, 메소드)끼리만 접근 가능
	// - 클래스 종류 : 일반적인 클래스들은 이부분을 생략
	//				   특정 틀래스는 해당 예약어를 사용(final, abstract)
	// - class : 클래스임을 나타내는 예약어
	// - 클래스 이름 : 클래스 이름은 = 저장이름 = 생성자
	// 				   첫글자 대문자 나머지 소문자, 
