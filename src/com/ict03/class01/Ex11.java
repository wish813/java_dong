...
public class Ex11 {
	...
	//		   오버로딩이란 하나의 클래스 안에 같은이름의 메소드가 여러개 존재하는 것을 말한다.
	//		   (단, 인자의 종류나 갯수나 순서가 달라야 한다.)
	
	private String name = "둘리";     // 멤버필드
	private int age = 24;			 // 멤버필드
	private boolean gender = true;  // 멤버필드
	...
	// 기본 생성자가 아닌 다른 생성자(즉, 인자가 있는 생성자 만듬)
