...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println(date.getYear()+(1900)+"년도 ");  //  Calendar.get(Calender.YEAR) = 2021-1900
		System.out.println(date.getMonth()+1+"월");  // 0-11 0이 1월 그러니+1 해주기
		...
		System.out.println(date.getDay());  // Calender.get(Calendar.DAY_OF_WEEK) 요일인데(0=>일요일, ~6=>토요일)
		
		System.out.println("==================================");
		
		// Calendar 클래스
		// 현재 날짜와 시간을 구할때는 new 예약어를 사용하지 않고 객체 생성한다.
		// 년, 월, 일, 시, 분, 초 를 구할때 Calender.getInstance().get (Calendar.상수)를 사용한다
