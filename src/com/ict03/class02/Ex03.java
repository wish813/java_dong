...
public class Ex03 {
	public static void main(String[] args) {
		...
		// 2) (int)(nextDouble() * 숫자) : 0 ~ 정수 전가지 난 수 발생
		...
		// 2) 특정 범위를 지정할 때
			...
			System.out.println("올림 : " + Math.ceil(3.34));  // 4
			System.out.println("올림 : " + Math.ceil(3.55));  // 4
			
			System.out.println("버림 : " + Math.floor(3.34));  // 3
			System.out.println("버림 : " + Math.floor(3.55));  // 3
		
			System.out.println("반올림 : " + Math.round(3.34));  // 3
