	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < j_arr.size(); i++) {
				JSONObject j_ob3 = (JSONObject) j_arr.get(i);
				String name = (String) j_ob3.get("LBRRY_NAME");
				String no = (String) j_ob3.get("TEL_NO");
				String addr = (String) j_ob3.get("ADRES");
				sb2.append(name+"\t\t");
				sb2.append(no+"\t\t");
				sb2.append(addr+"\n");
				// sb2.append(j_arr.get(i)+"\n");
